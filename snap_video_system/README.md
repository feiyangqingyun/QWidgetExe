...
### 0.4 编译说明
#### 0.4.1 版本说明
1. 本系统没有说基于哪个Qt版本，由于系统中电子地图模块用到了浏览器模块，所以理论上要求你电脑的Qt版本也有浏览器模块才行（win上Qt5.6以上的版本需要msvc编译器的版本才有，其余系统都会有），如果没有则电子地图模块不可用，但是其余功能全部可用没有任何影响。
2. 本人亲测4.7、4.8、5.5、5.6、5.7、5.9、5.12、5.13、5.14、5.15等。
3. 2021-1-6开始集成了miniblink浏览器内核，意味着mingw版本的qt5.6以上版本也全部支持。
...
5. 摄像机格式说明：https://blog.csdn.net/qq_38880380/article/details/80652697
